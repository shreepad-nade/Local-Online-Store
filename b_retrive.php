...
if($_POST || isset($_SESSION['cat']))
{
	...
	{
		$category_p=$_SESSION['cat'];
		//echo $category_p;
		//$_SESSION['email']=return_email();
	}
	else
	{
	...
	{
		echo '<hr><center><h2><b><i class="fas fa-apple">FOODS PRODUCTS</i></b></h2></center><hr>'.'';
		$category_p='Food';
	}
	else if(isset($_POST['PERSONAL_CARE']) || (isset($_SESSION['cat']) && $_SESSION['cat']=='PERSONAL_CARE'))
	{
		echo '<hr><center><h2><b><i class="fas fa-apple">PERSONAL CARE</i></b></h2></center><hr>'.'';
		$category_p='Personal care';
	}
	else if(isset($_POST['FASHION']) || (isset($_SESSION['cat']) && $_SESSION['cat']=='Fashion'))
	{
		echo '<hr><center><h2><b><i class="fas fa-apple">FASHION</i></b></h2></center><hr>'.'';
		$category_p='Fashion';
	}
